...
# !!! Since the latest Fedora kernel is older than this kernel, everything
...
%if %{nopatches}
# ###### NorNet Kernel ######
# NOTE: Had to deactivate the following definition, since it causes "-" to appear twice in package name.
# ###### NorNet Kernel ######
...
Source5008: 0001-MPTCP-v0.95-with-socketoptions-against-v4.19.118.patch
# ###### NorNet Kernel ######
...
# ###### NorNet Kernel ######
# NOTE: The MPTCP patch is added as a source file, not as patch (which would have to be in mbox format).
# ###### NorNet Kernel ######
    if [ "${patch:0:8}" != "patch-4." -a "${patch:0:11}" != "0001-MPTCP-" ] ; then
...
# ###### NorNet Kernel ######
ApplyPatch 0001-MPTCP-v0.95-with-socketoptions-against-v4.19.118.patch
# ###### NorNet Kernel ######
...
%endif
    ...
    ls -l $RPM_BUILD_ROOT/%{image_install_path}/$InstallName-$KernelVer
        # ###### NorNet Kernel ######
    # TD: sha512hmac does not work in build container! => use sha512sum instead.
    # sha512hmac $RPM_BUILD_ROOT/%{image_install_path}/$InstallName-$KernelVer | sed -e "s,$RPM_BUILD_ROOT,," > $RPM_BUILD_ROOT/%{image_install_path}/.vmlinuz-$KernelVer.hmac;
    sha512sum $RPM_BUILD_ROOT/%{image_install_path}/$InstallName-$KernelVer | sed -e "s,$RPM_BUILD_ROOT,," > $RPM_BUILD_ROOT/%{image_install_path}/.vmlinuz-$KernelVer.hmac;
    # ###########################
